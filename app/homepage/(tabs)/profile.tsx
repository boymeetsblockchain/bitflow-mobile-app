  ...
  return (
    <SafeViewComponent>
      ...
      <View style={tw`gap-y-5 px-6`}>
        {/* Full Name */}
        <View>
          <TextWrapperWhite style={tw` mb-2`} fontWeight='bold'>Full Name</TextWrapperWhite>
          <View style={tw`bg-[#8C6744] flex-row justify-between p-3 rounded-md items-center`}>
        ...
        {/* Email */}
        <View>
          <TextWrapperWhite style={tw` mb-2`} fontWeight='bold'>Email</TextWrapperWhite>
          <View style={tw`bg-[#8C6744] flex-row justify-between p-3 rounded-md items-center`}>
        ...
        {/* Phone Number */}
        <View>
          <TextWrapperWhite style={tw` mb-2`} fontWeight='bold'>Phone Number</TextWrapperWhite>
          <View style={tw`bg-[#8C6744] flex-row justify-between p-3 rounded-md items-center`}>
        ...
        {/* Address */}
        <View>
          <TextWrapperWhite style={tw` mb-2`} fontWeight='bold'>Address</TextWrapperWhite>
          <View style={tw`bg-[#8C6744] flex-row justify-between p-3 rounded-md items-center`}>
       ...
       <View>
        ...
        <Pressable style={tw `flex-row justify-between p-3 bg-[#8C6744] rounded-md`}>
