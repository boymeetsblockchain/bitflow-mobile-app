  ...
  return (
    <SafeViewComponent>
      ...
      >
        ...
        <TextWrapperWhite style={tw`text-sm text-white`} fontWeight="bold">Send & Receive</TextWrapperWhite>
      </Pressable>
      <Pressable
      ...
      >
        ...
        <TextWrapperWhite style={tw`text-sm text-white`} fontWeight="bold">Pay Bills</TextWrapperWhite>
      </Pressable>
      ...
      >
        ...
        <TextWrapperWhite style={tw`text-sm text-white`} fontWeight="bold">Withdraw</TextWrapperWhite>
      </Pressable>
    </View>
    <View style={tw`flex-row justify-between my-2 items-center`}>
     ...
     <Pressable
      ...
      >
        ...
        <TextWrapperWhite style={tw`text-sm text-white`} fontWeight="bold">Refer</TextWrapperWhite>
      </Pressable>
     <Pressable
        onPress={() => router.push("/services/recharge")}
        style={tw` items-center justify-center p-2 rounded-md`}
      >
        ...
        <TextWrapperWhite style={tw`text-sm text-white`} fontWeight="bold">Buy & Sell</TextWrapperWhite>
      </Pressable>
     </View>
