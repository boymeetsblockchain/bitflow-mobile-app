  ...
  return (
    <View>
      <View style={tw`flex-row justify-between px-3`}>
        <TextWrapperWhite fontWeight="bold">Features</TextWrapperWhite>
        <Pressable onPress={() => router.push("/features")}>
          <TextWrapperWhite fontWeight="bold">View All</TextWrapperWhite>
        </Pressable>
      </View>
      <View style={tw`flex-row justify-between my-2 items-center`}>
        ...
        >
          <Image
            ...
            style={tw`h-12 w-12`}
          />
          <TextWrapper style={tw`text-sm text-white`} fontWeight="bold">
            Buy & Sell
          </TextWrapper>
        </Pressable>
        <Pressable
