    ...
    return (
        ...
        <View style={tw ``}>
          ...
          <View style={tw ` bg-white p-3 rounded-md flex-row justify-between items-center`}>
              ...
              <Image source={require('../../assets/images/usa.png')} style={tw `h-8 w-8 rounded-full`}/>
        ...
        <View style={tw ``}>
          ...
          <View style={tw ` bg-white p-3 rounded-md flex-row justify-between items-center`}>
              <View style={tw `flex-row items-center gap-x-4`}>
              <Image source={require('../../assets/images/usdt.png')} style={tw `h-8 w-8 rounded-full`}/>
             
              </View>
              <TextWrapper fontWeight="bold">$41,000</TextWrapper>
          </View>
        </View>
       ...
       <View style={tw ``}>
          ...
          <View style={tw ` bg-white p-3 rounded-md flex-row justify-between items-center`}>
              <View style={tw `flex-row items-center gap-x-4`}>
              <Image source={require('../../assets/images/9ja.png')} style={tw `h-8 w-8 rounded-full`}/>
              <TextWrapper fontWeight="bold">NGN</TextWrapper>
              </View>
              <Entypo name="chevron-small-down" size={24} color="black" />
          </View>
        </View>
